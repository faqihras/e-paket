...
function setGrid2(id){
    ...
    $.ajax({
        type: "GET",
        url: 'backend/public/lang/admin/master/santri/grid',
        dataType:"json",
        async:false,
        success:function(data){
            console.log(data);
    ...
    var table=$('#tData2').DataTable({
        ...
        "serverSide": true,
        "ajax": {
                    "url" : "backend/public/api/admin/master/santri",
                    "data" : ({'santriNis':id}),
                    "dataType" : "json",
                },
...
function cari_detail(){
    $.ajax({
        ...
        success:function(data){
            ...
            setGrid2search(data.kolom,"backend/public/api/admin/master/santri","backend/public/lang/admin/master/santri/form",norm,nama,alamat,tgllhr);
        }
    });
}
...
function refresh_detail(){
   $.ajax({
    ...
    setGrid(data.kolom,"backend/public/api/admin/master/santri","backend/public/lang/admin/master/santri/form");
