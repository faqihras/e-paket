                        ...
                        success:function(data3){
                            ...
                            for (i = 0; i <= fElement.length-1; i++) {
                                ...
                                if(fElement[i].type=='file'){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'backend/public/api/admin/setup/upload',
                                        dataType:"json",
                                        async: false,
                                        data:formdata,
                                        processData: false,  
...
function refreshlap(){
    ...
    var awal=document.getElementById('tgawal').value;
    var ahir=document.getElementById('tgahir').value;
    var rm=document.getElementById('filterrm').value;


    if(awal=='' || ahir=='' || rm==''){
        alert('Parameter Masih Kosong !!!');
        return;
    }
    ...
    var url="report/cetakkasir2.php";                    
    window.open(url+param, '_blank');

}

function refreshlap2(){
    ...
    var param='?data='+JSON.stringify(postData);
    var url="report/cetakkwitansi2.php";                    
    window.open(url+param, '_blank');
