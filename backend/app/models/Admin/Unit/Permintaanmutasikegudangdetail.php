...
class Permintaanmutasikegudangdetail extends BasicModels {

  protected $table = 'trMintaMutasiKeGudangDetail';
        ...
        * @var array
        */
    protected $fillable = array('mintaNoTrans','mintaTanggal','mintaUnit','mintaKdBarang','mintaNmBarang','mintaSatuan','mintaQty'
    //,'mintaKeterangan'
      );
